                  ...
                  <div className="flex items-center gap-x-10">
                    ...
                    <div className="flex items-center gap-2">
                      {[1.35, 2.45, 3.67].map((value, idx) => (
                        <p
                          key={idx}
                          className={`text-xs px-3 py-1 rounded-md font-medium cursor-pointer hover:bg-gray-700 transition ${
                            idx === 1
                              ? "bg-green-500 text-black" // Apply green background and black text for the middle odds
                              : "bg-gray-800 text-booka"
                          }`}
                        >
                          {value}
                        </p>
